package com.langlez.follow.contract

/**
 * 팔로우 그래프 조회. follow 모듈이 구현한다.
 *
 * 홈 타임라인은 "내가 팔로우한 사람의 글"이라 팔로우 관계를 알아야 하는데, 그건 follow 소유다.
 * echo 가 follow 저장소를 직접 들여다보면 경계가 무너지고, 이벤트로 그래프를 복제하면
