...
class MemberTest : FunSpec({
    ...
    test("잘못된 handle 형식 검증") {
        Member.isValidHandle("AB") shouldBe false // 대문자
        ...
        Member.isValidHandle("User_Name") shouldBe false // 대문자 포함
    }
    ...
    test("로그인 처리") {
        ...
        member.login()
        member.audit.lastLoggedInAt shouldBe member.audit.lastLoggedInAt
    }
