 ...
 */
@Component
internal class RelationshipOutBoxScheduler(repo: RelationshipOutBoxRepository) :
    OutBoxProcessor<RelationshipOutBox>(repo) {
    ...
    @Scheduled(cron = "*/2 * * * * *")
    @DistributedLock(prefix = "lock:relationship-outbox")
