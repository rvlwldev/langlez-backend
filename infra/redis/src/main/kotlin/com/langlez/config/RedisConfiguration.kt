...
class RedisConfiguration(private val properties: RedisProperties) {
    ...
    fun redisConnectionFactory() = LettuceConnectionFactory(
        when {
            ...
            properties.sentinel != null && properties.sentinel.nodes.isNotEmpty() -> {
                RedisSentinelConfiguration(properties.sentinel.master, properties.sentinel.nodes.toSet())
    ...
    @Bean
    fun template(factory: RedisConnectionFactory, mapper: ObjectMapper) = RedisTemplate<String, Any>().apply {
