...
class GlobalRestControllerAdvice(private val source: MessageSource) {
    ...
    fun handleValidationException(e: MethodArgumentNotValidException, locale: Locale): ResponseEntity<ExceptionResponse> {
    ...
    fun handleMessageNotReadableException(e: HttpMessageNotReadableException, locale: Locale): ResponseEntity<ExceptionResponse> {
